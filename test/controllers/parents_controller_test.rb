...
class ParentsControllerTest < ActionController::TestCase
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post :create, parent: { car_model,: @parent.car_model,, license_plate: @parent.license_plate, name,: @parent.name, }
    end
  ...
  test "should update parent" do
    patch :update, id: @parent, parent: { car_model,: @parent.car_model,, license_plate: @parent.license_plate, name,: @parent.name, }
    assert_redirected_to parent_path(assigns(:parent))
  end
